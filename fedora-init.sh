...
echo "dnf install -y git-core zsh vim terminator firefox thunderbird dotnet-sdk-3.1 dotnet-sdk-5.0 nodejs npm sublime-text sublime-merge code 1password docker-ce docker-ce-cli"
dnf install -y git-core zsh vim terminator firefox thunderbird dotnet-sdk-3.1 dotnet-sdk-5.0 nodejs npm sublime-text sublime-merge code 1password docker-ce docker-ce-cli
